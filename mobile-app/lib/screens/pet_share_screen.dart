  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(20), children: [
        ...
        if (grant == null) ...[
          DropdownButtonFormField<String>(initialValue: _level, decoration: const InputDecoration(labelText: 'Permissão'), items: const [DropdownMenuItem(value: 'READ', child: Text('Somente leitura')), DropdownMenuItem(value: 'WRITE', child: Text('Leitura e registro clínico'))], onChanged: (v) => setState(() => _level = v ?? 'READ')),
